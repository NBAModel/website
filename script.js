...
btn.onclick = function() {
    ...
    document.getElementById("explanation-text").innerHTML = `
        ...
        <p><strong>The values for the weights of these statistics are derived from data from the past 25 NBA seasons using a machine learning algorithm called SHAP. Using data from a website called basketball reference, which tracks NBA statistics, inputted into a tree based regressor algorithm, SHAP compares success in each of the statistics to total playoff wins (The NBA Champion will always win 16 playoff games). Using this data it assigns each statistic a value depending on the strength of its correlation. Using these results I chose the 15 most relevant statistics to use in my model.The values for the weights of these statistics are derived from data from the past 25 NBA seasons using a machine learning algorithm called SHAP. Using data from a website called basketball reference, which tracks NBA statistics, inputted into a tree based regressor algorithm, SHAP compares success in each of the statistics to total playoff wins (The NBA Champion will always win 16 playoff games). Using this data it assigns each statistic a value depending on the strength of its correlation. Using these results I chose the 15 most relevant statistics to use in my model.</strong></p>
